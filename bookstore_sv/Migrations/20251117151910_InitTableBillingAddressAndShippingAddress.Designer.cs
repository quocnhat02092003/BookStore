...
namespace bookstore_sv.Migrations
{
    ...
    [Migration("20251117151910_InitTableBillingAddressAndShippingAddress")]
    partial class InitTableBillingAddressAndShippingAddress
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Order_Billing_Address", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Order_Shipping_Address", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Order_Billing_Address", b =>
                {
                    b.HasOne("Order", "Order")
                        ...
                        .HasForeignKey("Order_Billing_Address", "order_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Order_Shipping_Address", b =>
                {
                    b.HasOne("Order", "Order")
                        ...
                        .HasForeignKey("Order_Shipping_Address", "order_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
